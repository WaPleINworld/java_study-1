...
//			}
	...
	public static void prac05() {
		...
		//		평균 점수: 82.5
		//		80점 이상 학생 수: 6명
		int[] arr = {88, 92, 75, 63, 95, 70, 85, 90, 100, 67};
		...
		System.out.println("최저 점수: "+arr[0]);
		...
		System.out.println("최고 점수: "+arr[0]);
		//======================================
		...
		System.out.printf("평균 점수: %.1f",avg/10.0);
		//======================================
		int num=0;
		for (int i = 0; i < arr.length; i++) {
			if(arr[i]>=80) {
		...
		System.out.println("");
		System.out.printf("80점 이상 학생 수: %d명",num);
